...
\draw [step=1] (2,0) grid (3,5);
\draw (2.5,0.5) node[] {\small 13};
\draw (2.5,1.5) node[] {\small 10};
\draw (2.5,2.5) node[] {\small 4};
\draw (2.5,3.5) node[] {\small 2};
\draw (2.5,4.5) node[] {\small 1};

\draw [step=1] (3,0) grid (4,5);
\draw (3.5,0.5) node[] {\small 12};
\draw (3.5,1.5) node[] {\small 11};
\draw (3.5,2.5) node[] {\small 6};
\draw (3.5,3.5) node[] {\small 5};
\draw (3.5,4.5) node[] {\small 3};
