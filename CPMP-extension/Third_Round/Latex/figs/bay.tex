...
\draw  (1.5-2-1,0.1) ellipse (.08 and .1);
\draw  (5.5,0.1) ellipse (.08 and .1);
\fill [fill=white, draw=black] (1.5-2.1-1,0.1)--(1.5-1.9-1,0.1)--(1.5-1.9-1,5.1)--(5.4,5.1)--(5.4,0.1)--(5.6,0.1)--(5.6,5.3)--(1.5-2.1-1,5.3)--cycle;
...
\draw  (0,0.5)  node[left] {\small 1};
\draw  (0,1.5)  node[left] {\small 2};
\draw  (0,2.5)  node[left] {\small 3};
\draw  (0,3.5)  node[left] {\small 4};
\draw  (0.3,4.2)  node[left] {\small Tier};
